...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'Autentikasi dua faktor sudah aktif. Pindai kode QR atau masukkan kunci setup ke aplikasi autentikator Anda.',
            buttonText: 'Tutup',
        };
    }
    ...
    return {
        ...
        description:
            'Untuk menyelesaikan aktivasi autentikasi dua faktor, pindai kode QR atau masukkan kunci setup ke aplikasi autentikator Anda',
        buttonText: 'Lanjutkan',
    };
});
